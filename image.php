	...
	<div id="mdclcntr_content" role="main">
		<?php if ( have_posts() ) :
			while ( have_posts() ) : the_post(); ?>
				<div id="nav-single">
					<span class="nav-previous"><?php previous_image_link( '%link', '<span class="meta-nav">&larr;</span> ' . __( 'Previous', 'medical-center' ) ); ?></span>
					<span class="nav-next"><?php next_image_link( '%link', __( 'Next', 'medical-center' ) . '<span class="meta-nav">&rarr;</span>' ); ?></span>
				</div><!-- #nav-single -->
				...
				<article <?php post_class(); ?>>
					<header>
						...
						<div class="mdclcntr_meta">
							<?php _e( 'Posted on', 'medical-center' ); ?> <a href="<?php the_permalink(); ?>"><?php the_date(); ?></a>
							<?php _e( 'at', 'medical-center' ); ?>
							<a href="<?php echo wp_get_attachment_url(); ?>" target="_blank"><?php echo $metadata['width'] . ' &times; ' . $metadata['height']; ?></a>
							<?php _e( 'in', 'medical-center' ); ?>
